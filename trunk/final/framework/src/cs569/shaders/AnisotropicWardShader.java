...
public class AnisotropicWardShader extends GLSLShader {
	...
	protected void retrieveGLSLParams(GL gl) throws GLSLErrorException {
		...
		alphaX = getNamedParameter(gl, "alphaX");
		alphaY = getNamedParameter(gl, "alphaY");
	}
	...
	public void setGLSLParams(GL gl, Object... params) {
		...
		float alphaXValue = ((Float) params[3]).floatValue();
		float alphaYValue = ((Float) params[4]).floatValue();
		...
		gl.glUniform1f(alphaX, alphaXValue);
		gl.glUniform1f(alphaY, alphaYValue);
	}
}
